...
describe("walkContentBlocks", () => {
  ...
  it("visits nested content blocks in document order", () => {
    ...
    content = addRow(content, sectionId);
    ...
    content = addContentBlock(content, firstColumnId, "heading");
    content = addContentBlock(content, firstColumnId, "text");
    content = addContentBlock(content, secondColumnId, "button");
